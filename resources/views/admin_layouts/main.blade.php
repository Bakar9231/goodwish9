...
<head>
    ...
    <link href="{{ asset('assets/css/toogle.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/components.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/css/custom.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/data.css') }}" rel="stylesheet">
    
    <link rel='shortcut icon' type='image/x-icon' href="{{ asset('assets/img/GoodWish-Logo-App-Icon.png') }}" />
    <link rel="stylesheet" href="{{ asset('assets/bundles/sweetalert/css/sweetalert.css') }}">
    <script>
        var user_type = {{ Session::get('admin_id') }};
    </script>
...
<body class="light dark-sidebar theme-black">
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <span class="d-sm-none d-lg-inline-block"></span></a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            @elseif( session()->get('role') == "partner")
                            <div class="dropdown-title">Hello {{ session()->get('name') }}</div>
                            <a href="{{ route('partner/my-profile') }}" class="dropdown-item has-icon"> <i
                                    class="farfa-user"></i> Profile
                            </a>
                            @endif
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('logout', ['flag' => 0]) }}"

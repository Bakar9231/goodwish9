...
<head>
  ...
  <title>Admin Login - GoodWish9</title>
  ...
  <link rel='shortcut icon' type='image/x-icon' href='assets/img/GoodWish-Logo-App-Icon.png' />
          ...
          <div class="card text-center card-primary">
              <div class="card-header text-center">
                <div class="card-title">
                  <img src="{{url('/uploads/GoodWish-Logo-App-Icon.png')}}" width="30%" alt="Image"/>
                </div>
              </div>
              <h4>Admin Login</h4>
              
              <div class="card-body text-left">
                <form class="needs-validation" id="loginform" action="{{ route('login.submit') }}" method="post" novalidate="">
                {{ csrf_field() }}

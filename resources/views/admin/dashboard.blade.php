        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <i class="fas fa-handshake"></i>
                ...
                <div class="padding-20">
                    <div class="text-right">
                    <h3 class="font-light mb-0">
                        <i class="ti-arrow-up text-success"></i>  <h2>{{$totalpartner}}</h2>
                    </h3>
                    <a href="{{ url('/partner/list') }}">
                        <h5 class="font-15"> Partners</h5></a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card card-statistic-1">
               ...
               <i class="fas fa-rocket"></i>
                ...
                <div class="padding-20">
                    ...
                    <a href="{{ url('/subscription/list') }}"> <h5 class="font-15">Subscription</h5> </a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card card-statistic-1">
               ...
               <i class="fas fa-rocket"></i>
                ...
                <div class="padding-20">
                    <div class="text-right">
                    <h3 class="font-light mb-0">
                        <i class="ti-arrow-up text-success"></i>  <h2>{{$active_subscription}}</h2>
                    </h3>
                    <a href="{{ url('/subscription/list') }}"> <h5 class="font-15">Active Subscription</h5> </a>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            <div class="card card-statistic-1">
               ...
               <i class="fas fa-rocket"></i>
                ...
                <div class="padding-20">
                    <div class="text-right">
                    <h3 class="font-light mb-0">
                        <i class="ti-arrow-up text-success"></i>  <h2>{{$notactive_subscription}}</h2>
                    </h3>
                    <a href="{{ url('/subscription/list') }}"> <h5 class="font-15">Expired Subscription</h5> </a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card card-statistic-1">
                ...
                <div class="padding-20">
                    ...
                    <a href="{{ url('/content/list') }}"><h5 class="font-15"> Movies</h5></a>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="card card-statistic-1">
                ...
                <div class="padding-20">
                    <div class="text-right">
                    <h3 class="font-light mb-0">
                        <i class="ti-arrow-up text-success"></i>  <h2>{{$totalRealityshow}}</h2>
                    </h3>
                    <a href="{{ url('/content/list') }}">
                        <h5 class="font-15"> Reality Shows</h5></a>
                    </div>
                </div>
                </div>
            </div>

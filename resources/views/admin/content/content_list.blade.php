                ...
                <div class="card-statistic-4">
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 ">
                                <div class="card-content text-center">
                                    <h3 class="font-20 total_content" style="color: dodgerblue;"> {{$total_realtiyshow}} </h3>
                                    <span class="badge badge-success text-center">Reality Show</span>
                                </div>
                            </div>                            
                        </div>
                    </div>
              ...
              <div class="tab" role="tabpanel">
                <ul class="nav nav-pills border-b mb-0 p-3">
                    <li role="presentation" class="nav-item"><a class="nav-link pointer active" href="#Section0" aria-controls="home" role="tab" data-toggle="tab">Movie </a></li>
                     <li role="presentation" class="nav-item"><a class="nav-link pointer" href="#Section2" aria-controls="home" role="tab" data-toggle="tab">Reality Show </a></li>
               ...
               <!--<div class="tab-content tabs" id="home">-->
                  ...
                  <div role="tabpanel" class="tab-pane" id="Section2">
                    ...
                    <div class="card-body">	
                      ...
                      <div class="table-responsive">
                          <table class="table table-striped" id="realityshow-listing" width="100%">
                            <thead>
                              <tr>
                                <th>Verticle Poster</th>
                                <th>Horizontal Poster</th>
...
//   reality show
 var dataTable = $('#realityshow-listing').dataTable({
    'processing': true,
    'serverSide': true,
    'serverMethod': 'post',
    "order": [[ 0, "desc" ]],

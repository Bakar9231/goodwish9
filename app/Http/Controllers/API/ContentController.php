...
class ContentController extends Controller
{
    ...
    public function getAllContentList(Request $request)
    {
        try {
            ...
            $ContentData =  Content::select('content_id', 'content_type', 'content_title', 'ratings', 'verticle_poster', 'horizontal_poster')->orderBy('id', 'DESC')->offset($start)->limit($limit)->get();
        ...
        try {
            ...
            if ($search) {
                ...
                $ContentData =  $query->where('content_title', 'LIKE', "%{$search}%")->offset($start)
                    ->limit($limit)->orderBy('id', 'DESC')->offset($start)->limit($limit)->get();
            } else {
                $query =  Content::select('content_id', 'content_type', 'content_title', 'ratings', 'verticle_poster', 'horizontal_poster');
                if ($content_type) {
                    $query->where('content_type', $content_type);
                ...
                $ContentData =  $query->orderBy('id', 'DESC')->offset($start)->limit($limit)->get();
            }
    ...
    public function getMovieList(Request $request)
    {
        try {
            ...
            $ContentData =  Content::select('content_id', 'content_type', 'content_title', 'ratings', 'verticle_poster', 'horizontal_poster')->where('content_type', 1)->orderBy('id', 'DESC')->offset($start)->limit($limit)->get();
    ...
    public function getSeriesList(Request $request)
    {
        try {
            ...
            $ContentData =  Content::select('content_id', 'content_type', 'content_title', 'ratings', 'verticle_poster', 'horizontal_poster')->where('content_type', 2)->orderBy('id', 'DESC')->offset($start)->limit($limit)->get();

            ...
            <form class="forms-sample" id="sendNotification">
              ...
              <div class="form-row">
                  <div class="form-group col-md-4">
                      ...
                      <option value="flixy">GoodWish9</option>
                      </select>
                  </div>
                  <div class="form-group col-md-4">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="hidden_notification_img" id="hidden_notification_img" value="">
          </div>
          </div>
...
$(document).ready(function (){
  ...
  var dataTable = $('#notification-listing').dataTable({
    ...
    $("#notification-listing").on("click", ".UpdateNotification", function() {
        ...
        var html = '<div class="borderwrap"><div class="filenameupload"><img src="{{env("DEFAULT_IMAGE_URL")}}'+notification_img+'" width="130" height="130"> </div>  </div>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success == 1) {
                      ...
                      swal("Confirm!", "Notification has not been deleted!", "error");
                    }
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    alert(errorThrown);

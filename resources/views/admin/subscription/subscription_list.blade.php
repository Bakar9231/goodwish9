      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="m-0">Subscriber (<span class="total_partners">
                {{ $total_user }}
              </span>)</h4>
          </div>
    ...
    <div class="modal-content">
      ...
      <form id="addUpdatePartner" method="post" enctype="multipart">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="password">Password</label>
            <input id="upd-password" name="password" type="password" class="form-control form-control-danger" placeholder="Enter Password">
          </div>
